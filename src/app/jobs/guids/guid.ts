...
constructor(jobid:string,guid:string,id:number,physicalInspectionResult:number,rejectReason:string,completionTime:string,testOutcome:string,testBenchResults:any[],ReTestResult:any[]){
